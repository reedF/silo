...
public class MyMqttClient implements MqttCallbackExtended {
	...
	public void disconnect() {
		...
		try {
			...
			e.printStackTrace();
			log.error("====mqttClient disconnect error====", e);
		}
	}
	...
	public void connectComplete(boolean reconnect, String serverURI) {
		...
		if (reconnect) {
			...
			log.info("====mqttClient reconnected====");
		} else
			onConnected();
	}
	...
	public boolean subscribeToTopic(String subscriptionTopic) {
		...
		try {
			...
			//ex.printStackTrace();
			log.error("====mqttClient subscribeToTopic error====", ex);
			return false;
		}
	}
	...
	public boolean unsubscribeToTopic(String subscriptionTopic) {
		...
		try {
			...
			//ex.printStackTrace();
			log.error("====mqttClient unsubscribeToTopic error====", ex);
			return false;
		}
	}
	...
	public boolean publishMessage(String publishTopic, String publishMessage) {
		...
		try {
			...
			//e.printStackTrace();
			log.error("====mqttClient pub msg error====", e);
			return false;
		}
	}
	...
	private void reconnectionHandle(Throwable cause) {
		...
		log.error("====mqttClient connect lost====", cause);
	}
